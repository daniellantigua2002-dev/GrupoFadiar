...
//             <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-end', columnGap: theme.spacing(4), position: 'relative', pb: 0.5 }}>
...
//         <Box sx={{ position: 'absolute', top: '2%', left: '2%', width: '65%', bgcolor: 'background.paper', boxShadow: 24, borderRadius: 2 }}>
...
export const NavBar = () => {
  ...
  return (
    <AppBar position="static" color="inherit" elevation={0} sx={{ backgroundColor: '#fff' }}>
      ...
      {/* ----------------------------------------- */}
      {/*        PROFILE MENU (USANDO TU COMPONENTE) */}
      {/* ----------------------------------------- */}
      <ProfileMenu
        open={openProfile}
